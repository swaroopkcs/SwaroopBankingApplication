		...
		do {
			...
			for (int i = 0; i < 3; i++) {
				...
				if (bankingRules.userIdentification(userID, passOrPin)) {
					...
					System.out.println("Press 1 for deposit, 2 for withdrawal, 3 for fundTransfer and 4 for "
							+ bankingRules.verPass + " change");
					...
					case 4:
						String choice = "";
						do {
							System.out.println("Please enter new "+bankingRules.verPass);
							String newPin1 = sc.next();
							System.out.println("Please re-enter the new "+bankingRules.verPass);
							...
							if (bankingRules.verPassChange(newPin1, newPin2)) {
								...
								System.out.println("The " + bankingRules.verPass
										+ " entered does not match. Please press y if you want to try again.");
								choice = sc.next();
							}
			...
			System.out.println(
					"Please press Y if you want to complete another operation. " + "Press anything else to exit.");
